...
class Book extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            BelongsTo::make('Book Author','bookAuthor')->searchable()->withoutTrashed(),
            BelongsTo::make('Book Category','bookCategory')->searchable()->withoutTrashed(),
            ...
            File::make('Book','e_book')
                ->disk('public')
                ->path('book/ebook')
                ->storeAs(function (Request $request) {
                    return Str::replace(' ','_',$request->e_book->getClientOriginalName());
                })
                ...
                ->prunable()
                ->creationRules('nullable')->updateRules('nullable'),
